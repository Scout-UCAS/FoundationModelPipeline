...
- Planned scale: 2710 TB
- Languages: 25
- Modalities: multimodal, pure_text, video_pretraining, vla
...
| --- | --- | ---: | --- | --- |
| warmup_2k | stabilize tokenizer, optimizer, and early curriculum | 150 | multimodal 16.0%, pure_text 72.0%, video_pretraining 8.0%, vla 4.0% | en 38.0%, other 38.0%, zh 24.0% |
| core_pretrain | maximize broad language, code, knowledge, and multimodal coverage | 1700 | multimodal 22.0%, pure_text 58.0%, video_pretraining 15.0%, vla 5.0% | en 35.0%, other 41.0%, zh 24.0% |
| multimodal_video_expansion | improve temporal understanding and image-video grounding | 450 | multimodal 34.0%, pure_text 20.0%, video_pretraining 38.0%, vla 8.0% | en 34.0%, other 40.0%, zh 26.0% |
| vla_alignment | bind perception, language instruction, and action policy traces | 120 | multimodal 20.0%, pure_text 10.0%, video_pretraining 25.0%, vla 45.0% | en 40.0%, other 25.0%, zh 35.0% |
| reasoning_final | raise high-quality reasoning, tool-use, and instruction-following density | 80 | multimodal 18.0%, pure_text 62.0%, video_pretraining 8.0%, vla 12.0% | en 42.0%, other 28.0%, zh 30.0% |
...
| ---: | --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 | hybrid-mamba-transformer | Hybrid Architecture | 86.0B/86.0B | 1.960 | 2740 | 65.2 | 65.0 | 0.87 | 0.649 |
| 2 | moe-top2-64e | MoE | 45.0B/320.0B | 1.910 | 2320 | 66.8 | 72.0 | 0.88 | 0.647 |
| 3 | mtp-4head-decoder | MTP | 74.0B/74.0B | 1.930 | 2470 | 66.1 | 70.0 | 0.86 | 0.612 |
| 4 | linear-sparse-attn-32k | Sparse / Linear Attention | 72.0B/72.0B | 1.980 | 2860 | 63.5 | 62.0 | 0.84 | 0.579 |
| 5 | reasoning-native-verifier-policy | Reasoning-native Architecture | 90.0B/90.0B | 1.940 | 2130 | 72.4 | 79.0 | 0.82 | 0.544 |
| 6 | latent-reasoning-scratchpad | Latent Reasoning | 78.0B/78.0B | 1.950 | 2210 | 69.6 | 74.0 | 0.83 | 0.537 |
| 7 | rwkv-style-rnn-backbone | RNN-like Backbone | 70.0B/70.0B | 2.060 | 3150 | 59.4 | 54.0 | 0.82 | 0.463 |
| 8 | memory-augmented-retrieval-state | Memory-augmented LLM | 82.0B/82.0B | 1.990 | 2180 | 67.7 | 78.0 | 0.81 | 0.389 |
| 9 | omni-modal-unified-tokens | Omni-modal Architecture | 96.0B/96.0B | 1.970 | 2060 | 68.9 | 80.0 | 0.80 | 0.388 |
| 10 | diffusion-llm-dllm | dLLM | 68.0B/68.0B | 2.110 | 1980 | 61.2 | 76.0 | 0.79 | 0.058 |
...
| --- | --- | --- | --- | --- | --- |
| Pre-training | train base model on 2500T+ staged mixture | core_pretrain | Megatron-DeepSpeed | context=1, data=10, pipeline=4, tensor=8 | max_loss_spike_ratio<=1.35, max_nan_incidents<=0, min_gpu_utilization>=0.88 |
| SFT | align instruction following, multilingual dialogue, multimodal QA, and VLA commands | reasoning_final | FSDP | context=1, data=50, pipeline=2, tensor=4 | max_eval_regression<=0.02, min_instruction_win_rate>=0.58 |
| RL | optimize reasoning, preference, safety, and tool-use rewards | rl_reasoning_tool_mix | verl-compatible PPO/GRPO | context=1, data=50, pipeline=2, tensor=4 | max_kl<=0.12, min_reward_score>=0.62 |
...
| --- | ---: |
| agent | 0.1294 |
| edge_efficiency | 0.1059 |
| general | 0.1176 |
| long_context | 0.1059 |
| multimodal_understanding | 0.1412 |
| reasoning | 0.1647 |
| tool_calling | 0.0941 |
| vla | 0.1412 |
