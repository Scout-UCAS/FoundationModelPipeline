...
def main() -> int:
    parser = argparse.ArgumentParser(description="Agentic RL launcher")
    parser.add_argument("--config-dir", default="configs")
    parser.add_argument("--mixture", default="agentic_env_rollouts")
    parser.add_argument("--world-size", type=int, default=400)
    parser.add_argument("--output", default="artifacts/runs/agentic_rl_plan.json")
