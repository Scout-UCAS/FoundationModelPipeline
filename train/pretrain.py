...
def main() -> int:
    parser = argparse.ArgumentParser(description="Pre-training launcher")
    parser.add_argument("--config-dir", default="configs")
    parser.add_argument("--mixture", default="core_pretrain")
    parser.add_argument("--world-size", type=int, default=400)
    parser.add_argument("--output", default="artifacts/runs/pretraining_plan.json")
